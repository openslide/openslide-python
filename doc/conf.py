...
latex_documents = [
  ('index', 'OpenSlidePython.tex', 'OpenSlide Python Documentation',
   'OpenSlide project', 'manual'),
]
...
man_pages = [
    ('index', 'openslidepython', 'OpenSlide Python Documentation',
     ['OpenSlide project'], 1)
]
...
texinfo_documents = [
  ('index', 'OpenSlidePython', 'OpenSlide Python Documentation',
   'OpenSlide project', 'OpenSlidePython', 'One line description of project.',
   'Miscellaneous'),
]
